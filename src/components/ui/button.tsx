...
const buttonVariants = cva(
  "transition-all inline-flex items-center justify-center rounded-md text-sm font-medium cursor-pointer focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 ",
  {
    variants: {
      variant: {
        default:
