const HeroBlob = () => {
  return (
    <div className="animate-fadeIn absolute top-[50px] -z-10 w-[500px] max-w-[90%] overflow-hidden overflow-x-hidden opacity-20 blur-3xl">
      <svg
        viewBox="0 0 200 200"
      ...
      >
        <defs>
          <linearGradient
            id="vibrantBlueGrayGradient"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
          >
            <stop offset="0%" style={{ stopColor: "hsl(210, 100%, 50%)" }} />
            <stop offset="100%" style={{ stopColor: "hsl(210, 50%, 70%)" }} />
          </linearGradient>
        </defs>
        <path
          fill="url(#vibrantBlueGrayGradient)"
